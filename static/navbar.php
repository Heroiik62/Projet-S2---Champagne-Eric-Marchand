        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark row">
            ...
            <div class="collapse navbar-collapse col-md-12" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto col-md-12">
                  ...
                  <li class="nav-item {$actives[1]} text-center col-md-3">
                      <a class="nav-link" href="produit.php">Produits</a>
                  </li>
                  <li class="nav-item {$actives[2]} text-center col-md-3">
                      <a class="nav-link" href="contact.php">Contact</a>
                  </li>
                  <li class="nav-item {$actives[3]} text-center col-md-3">
                      <a class="nav-link" href="galerie.php">Galerie</a>
                  </li>
                  <li class="nav-item {$actives[4]} text-center col-md-1">
